...
from scripts.services.svc_md_to_html import convert_md_to_html  # noqa: E402
...
def main():
    parser = argparse.ArgumentParser(
        description="Convert Markdown text to HTML format", formatter_class=argparse.RawDescriptionHelpFormatter
    )
    ...
    try:
        ...
        logger.error(f"Error: Failed to convert to HTML - {e}")
        sys.exit(1)
